...
if __name__ == "__main__":
    ...
    # Example 5/6: typed and plain False in mux select.
    sel_typed_false = Const(False, Bool())
    sel_plain_false = False
    y_mux_typed_false = mux(sel_typed_false, a, b)
    y_mux_plain_false = mux(sel_plain_false, a, b)
